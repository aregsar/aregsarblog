...
[Adding a heading to our index.md page](#adding-a-heading-to-our-index-page)
...
[Linking to the blog post from index.md file](#linking-to-the-blog-post-from-index-file)
...
In these scenarios you just have to wait a bit for the dns records to propegate and https certificate to be generated by Github pages. Generally after a few minutes these issues will resolve on their own.

After you are able to check the Https checkbox and the cerificates are issued
the publish URL for the site will change as indicated by the message at the top of the github pages section, which for me is:
